...
import {updateId, updateUsername} from '../ducks/reducer'
  ...
  render(){
    return(
      <div>
        ...
        <h1 className='titleAuth'>Helo</h1>
        ...
        <div>
          ...
          <button onClick={(e) => this.handleRegisterFormSubmit(e)}>Register</button>
        </div>
        <p>{this.state.loginError && <span>{this.state.loginErrorMessage}</span>}</p>
      </div>
    )
  }
}
